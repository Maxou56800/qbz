...
QtObject {
    ...
    /// nothing in it touches the window edge. One value on every platform:
    /// a wider macOS gutter for the Liquid Glass corner was tried the same
    /// day and read as too much.
