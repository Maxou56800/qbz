...
const MASTERS: &[(&str, &str)] = &[
    ...
    ("database", include_str!("../qml/assets/icons/primary/database.svg")),
    ...
    ("paintbrush-vertical", include_str!("../qml/assets/icons/primary/paintbrush-vertical.svg")),
    ...
    ("skip-back-10", include_str!("../qml/assets/icons/primary/skip-back-10.svg")),
    ("skip-forward", include_str!("../qml/assets/icons/primary/skip-forward.svg")),
    ("skip-forward-10", include_str!("../qml/assets/icons/primary/skip-forward-10.svg")),
    ...
    ("unplug", include_str!("../qml/assets/icons/primary/unplug.svg")),
